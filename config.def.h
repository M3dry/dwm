...
static Key keys[] = {
	...
	{ A|S,          XK_e,   XK_e,          spawn,                  SHCMD("emacsclient -c -a emacs") },
	{ A|S,          XK_e,   XK_c,          spawn,                  SHCMD("emacsclient -c -a 'emacs' --eval '(ibuffer)'") },
	{ A|S,          XK_e,   XK_d,          spawn,                  SHCMD("emacsclient -c -a 'emacs' --eval '(dired nil)'") },
